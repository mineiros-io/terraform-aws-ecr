...
If you'd like to pull and push images from and to the registry with an IAM
principal such as an IAM user, you will need to request an authorization token
